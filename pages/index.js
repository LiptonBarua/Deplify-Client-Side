...
const Index = () => {
    return (
        <>
            ...
            <div className='md:max-w-[1140px] md:mx-auto mt-12'>
            <HappyCustomer></HappyCustomer>
            </div>
            <div className="bg-gradient-to-tr from-violet-900  to-blue-600 rounded-tl-[250px] dark:bg-gradient-to-r dark:from-lime-900 dark:to-lime-500 rounded-br-[250px] text-white pt-24 pb-64  md:py-24 mb-12">
                <ChoseUs />
            </div>
            <div className='md:max-w-[1140px] md:mx-auto my-12' >
                <TeamMember />
